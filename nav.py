...
with model:
    ...
    nengo.Connection(do_memory, mem_update.neurons, transform=-1*np.ones((mem_update.n_neurons, 1)))
    nengo.Connection(do_memory, wander.neurons, transform=-1*np.ones((wander.n_neurons, 1)))
    nengo.Connection(do_memory, search.neurons, transform=-1*np.ones((search.n_neurons, 1)))
    nengo.Connection(do_search, go_to_target.neurons, transform=-1*np.ones((go_to_target.n_neurons, 1)))
